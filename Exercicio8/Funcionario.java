...
class Funcionario {
	...
	//retorna uma string com a data do funcionario
	String getDataEntrada(){
		return this.dataDeEntrada.dia +"/"+this.dataDeEntrada.mes +"/"+this.dataDeEntrada.ano;
	}
	...
	void getStatus(){
		...
		System.out.println("Data: " +getDataEntrada());
